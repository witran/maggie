...
Node.add = lambda self, other: add(self, other)
Node.mul = lambda self, other: mul(self, other)
Node.pow = lambda self, other: power(self, other)
Node.log = lambda self: log(self)
Node.inv = lambda self: inv(self)
Node.neg = lambda self: neg(self)
Node.sub = lambda self, other: sub(self, other)
Node.div = lambda self, other: div(self, other)
